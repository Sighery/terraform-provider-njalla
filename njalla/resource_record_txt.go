...
func resourceRecordTXT() *schema.Resource {
	return &schema.Resource{
		...
		Read:   resourceRecordTXTRead,
		Update: resourceRecordTXTUpdate,
		Delete: resourceRecordTXTDelete,
...
func resourceRecordTXTCreate(d *schema.ResourceData, m interface{}) error {
	config := m.(*Config)
	...
	return resourceRecordTXTRead(d, m)

}

func resourceRecordTXTRead(d *schema.ResourceData, m interface{}) error {
	config := m.(*Config)
...
func resourceRecordTXTUpdate(d *schema.ResourceData, m interface{}) error {
	config := m.(*Config)
...
func resourceRecordTXTDelete(d *schema.ResourceData, m interface{}) error {
	config := m.(*Config)
